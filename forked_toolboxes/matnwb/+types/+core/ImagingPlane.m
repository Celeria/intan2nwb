...
properties
    ...
    grid_spacing_unit; % REQUIRED (char) Measurement units for grid_spacing. The default value is 'meters'.
    ...
    origin_coords_unit; % REQUIRED (char) Measurement units for origin_coords. The default value is 'meters'.
end
% OPTIONAL PROPERTIES
properties
